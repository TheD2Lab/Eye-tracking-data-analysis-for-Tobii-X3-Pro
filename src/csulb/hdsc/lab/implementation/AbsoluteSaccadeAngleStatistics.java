...
public class AbsoluteSaccadeAngleStatistics extends Analysis {

	private Median<Double> median;
	
	public AbsoluteSaccadeAngleStatistics( HashMap<Integer, ArrayList<String>> raw_data, HashMap<String,Integer> map ){
		super();
	...
	protected void crossColumnCompute(HashMap<Integer, ArrayList<String>> raw_data, HashMap<String, Integer> map) {
		...
		ArrayList<String> AbsAngleData = raw_data.get(map.get("AbsoluteSaccadicDirection"));
